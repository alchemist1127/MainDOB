 ...
 *
 * Shared between the driver (drivers/bga/main.c, future drivers) and
 * the client stub (libdob/src/DobVideoControl_stub.c, to be written).
 * Public API is in <DobVideoControl.h>; this file is the wire-level
 * details that no client code should ever include.
 *
 ...
 * ops, not introspection — see bga_transport_fast.c).  Cold path:
